...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('classnames'), require('react-dom'), require('lodash.omit'), require('lodash.pick'), require('react-datepicker'), require('react-popper'), require('nanoid'), require('react-transition-group'), require('nouislider')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'classnames', 'react-dom', 'lodash.omit', 'lodash.pick', 'react-datepicker', 'react-popper', 'nanoid', 'react-transition-group', 'nouislider'], factory) :
  (global = global || self, factory(global['shards-React'] = {}, global.React, global.classNames, global.ReactDOM, global.omit, global.pick, global.ReactDatePicker, global.ReactPopper, global.nanoid, global.ReactTransitionGroup, global.nouislider));
}(this, function (exports, React, classNames, ReactDOM, omit, pick, ReactDatePicker, reactPopper, nanoid, reactTransitionGroup, nouislider) { 'use strict';
  ...
  */
  ...
  Fade.propTypes = { ...Transition.propTypes,
  ...
  Fade.defaultProps = { ...Transition.defaultProps,
    tag: "div",
    baseClass: "fade",
  ...
  Collapse.propTypes = { ...Transition.propTypes,
  ...
  Collapse.defaultProps = { ...Transition.defaultProps,
    open: false,
    appear: false,
    enter: true,
    exit: true,
  ...
  class Dropdown extends React.Component {
    ...
    render() {
      ...
      }, /*#__PURE__*/React.createElement(reactPopper.Manager, attrs, /*#__PURE__*/React.createElement(DropdownContext.Consumer, null, () => /*#__PURE__*/React.createElement("div", {
        className: classes,
        ref: this.ref
      }, children))));
    }
  ...
  class DropdownToggle extends React.Component {
    ...
    render() {
      ...
      if (this.context.inNavbar) {
        return /*#__PURE__*/React.createElement(reactPopper.Reference, null, () => /*#__PURE__*/React.createElement(Tag, _extends({}, attrs, {
          className: classes,
          onClick: this.onClick,
  ...
  class DropdownMenu extends React.Component {
    render() {
      ...
      if (persist || this.context.open && !this.context.inNavbar) {
        ...
        return /*#__PURE__*/React.createElement(reactPopper.Popper, attrs, _ref => {
          let {
            ref,
            placement
          } = _ref;
  ...
  class FormCheckbox extends React.Component {
    ...
    render() {
      ...
      const id = _id || `dr-checkbox-${nanoid.nanoid()}`;
  ...
  class FormRadio extends React.Component {
    ...
    render() {
      ...
      const id = _id || `dr-radio-${nanoid.nanoid()}`;
      return /*#__PURE__*/React.createElement("label", {
        className: labelClasses
      }, /*#__PURE__*/React.createElement("input", _extends({}, attrs, {
        ref: innerRef,
